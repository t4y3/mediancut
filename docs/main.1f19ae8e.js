...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var uploadedElm = document.getElementById("uploaded");
  var uploadArea = document.getElementById("upload-area");
  var closeBtn = document.querySelector("#close");
  var swapBtn = document.querySelector("#swap");
  var defaultImage = document.getElementById("original-image");
  var beforeImage = document.querySelector("#beforeImage");
  var beforeImageSwap = document.querySelector("#beforeImageSwap");
  var colorSizeElm = document.querySelector("#colorSize");
  var spinnerElm = document.querySelector("#spinner");
  ...
  colorSizeElm.addEventListener("change", function (e) {
    showSpinner();
  ...
  showPreviewArea();
  defaultImage.addEventListener("load", function (image) {
...
var changeHandler = function changeHandler(_ref) {
  ...
  var file = data === undefined ? e.target.files[0] : data; // 拡張子チェック
...
var Cluster = /*#__PURE__*/function () {
  ...
  _createClass(Cluster, [{
    ...
    value: function reduce() {
      ...
      var ctx = this.canvas.getContext("2d");
      ctx.drawImage(this.__image, 0, 0, this.__image.width, this.__image.height, 0, 0, this.__image.width, this.__image.height);
